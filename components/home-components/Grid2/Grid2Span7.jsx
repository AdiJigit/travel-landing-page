...
export default function Grid2Span7() {
  return (
    <div className="mt-10 shadow-md">
      <div className="w-full">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/ZRqP3wNRglY" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className='w-full h-[500px]'></iframe>
      </div>
      <div className="mt-4">
        <p className="border-l-[5px] border-l-yellow-500 px-5 font-[500]">
          February 3, 2023 - Travel & World
        </p>
        ...
        <div className="flex gap-5">
          ...
          />
          <p className='font-[500] cursor-pointer'>Islands</p>
        </div>
        <div className='flex gap-5'>
        <Image
