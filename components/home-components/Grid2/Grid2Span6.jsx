...
export default function Grid2Span6() {
  return (
    <div className="mt-10 grid md:grid-cols-2 gap-10">
      <div className="shadow-md">
        <Image
          src="/assets/grid2span6-01.jpg"
          alt=""
          width={500}
          height={500}
        />
        <div>
          <p className="my-4 p-2 font-[500] border-l-[5px] border-l-yellow-500">
            November 17, 2022 - Tips & Tricks
          </p>
          <h1 className="px-2 my-16 text-3xl font-[500]">
          Many buildings especially in Japan          </h1>
          <div className="flex justify-between px-2 my-5">
            <div className="flex gap-3">
              ...
              />
              <p className="font-[500] cursor-pointer">Japan</p>
            </div>
            <div className="flex gap-3">
              <Image
      ...
      <div className="shadow-md">
        ...
        <div>
          <p className="my-4 p-2 font-[500] border-l-[5px] border-l-yellow-500">
            March 22, 2022 - Tips & Tricks
          </p>
          <h1 className="px-2 my-16 text-3xl font-[500]">
          There are roughly 1200 semiwild dear          </h1>
          <div className="flex justify-between px-2 my-5">
            <div className="flex gap-3">
              <Image
                src="/assets/geo-icon.png"
                ...
                className="w-[20px] h-[25px] cursor-pointer"
              />
              <p className="font-[500] cursor-pointer">New Zeland</p>
            </div>
            <div className="flex gap-3">
              <Image
                src="/assets/comment-icon.png"
